// Local Tab Archive — PNW Rural Oregon entries
// Small-town Oregon: Bend, Ashland, Medford, Klamath Falls, Burns, Pendleton,
// Grants Pass, La Grande, Roseburg, Coos Bay, Astoria/coast
// The Oregon that isn't Portland or Eugene
...
export const entries = [
  ...
  {
    "id": "rim-rock-basin-hymn",
    "band": "Rim Rock",
    "song": "Basin Hymn",
    "scene": "pnw",
    "sceneLabel": "PNW Rural OR",
    "tags": ["standard", "mid-tempo", "klamath-falls"],
    "fragments": [
      {
        "type": "tab-page",
  ...
  },
  {
    ...
    "scene": "pnw",
    "sceneLabel": "PNW Rural OR",
    "tags": ["drop-d", "mid-tempo", "la-grande"],
    "fragments": [
      {
        "type": "tab-page",
  ...
  {
    "id": "horse-trailer-frontage-hymn",
    "band": "Horse Trailer",
    "song": "Frontage Hymn",
    "scene": "pnw",
    "sceneLabel": "PNW Rural OR",
    "tags": ["standard", "slow", "grants-pass"],
    "fragments": [
      {
        "type": "tab-page",
  ...
  },
  {
    ...
    "scene": "pnw",
    "sceneLabel": "PNW Rural OR",
    "tags": ["standard", "slow", "coos-bay", "newport"],
    "fragments": [
      {
        "type": "tab-page",
  ...
  },
  {
    ...
    "scene": "pnw",
    "sceneLabel": "PNW Rural OR",
    "tags": ["standard", "mid-tempo", "ontario"],
    "fragments": [
      {
        "type": "tab-page",
